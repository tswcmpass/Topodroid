...
public class CavwayTakeShot extends AsyncTask<Integer, Integer, Integer >
{
   ...
   */
  public CavwayTakeShot(ILister ilister, ListerHandler lister, TopoDroidApp app, int nr, int data_type )
  {
    super();
    mILister  = ilister; 
    mLister   = lister; 
