...
{
  static final String CAVWAY_SRV_UUID_STR        = "6e400001-b5a3-f393-e0a9-e50e24dcca9e"; // DistoXBLE service uuid
  static final String CAVWAY_CHRT_READ_UUID_STR  = "6e400003-b5a3-f393-e0a9-e50e24dcca9e"; // DistoXBLE receive (from XBLE to app)
  static final String CAVWAY_CHRT_WRITE_UUID_STR = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"; // DistoXBLE send (from app to XBLE)
